          ...
          <tbody>
            {currentProducts.map((product) => (
              <tr key={product.id}>
                ...
                <td>{new Date(product.fechaVencimiento).toLocaleDateString()}</td>
        ...
        {editMode && (
          <div className="edit-product-form">
            ...
            <form>
              ...
              <label htmlFor="cantidadEntrada" className="campos-form-edit-product">
                Cantidad Entrada:
              </label>
              <input
                className="inputs-form-edit-product"
              ...
              <label htmlFor="fechaEntrada" className="campos-form-edit-product">
                Fecha Entrada:
              </label>
              <input
                className="inputs-form-edit-product"
              ...
              <label htmlFor="fechaVencimiento" className="campos-form-edit-product">
                Fecha Vencimiento:
              </label>
              <input
                className="inputs-form-edit-product"
